...
class Home extends Component {
    ...
    async componentDidMount() {
        try {
            var portfolioDataJSON = await axios.get(`${Constants.getPortfolio}`, {
                headers:{
        ...
        return (<div className="App">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
                <div className="col-md-3 portfolio-summary">
                    <div style={{ border: "5px solid black", marginTop: "20PX", backgroundColor: "#171123", borderRadius: "2px 16px", justifyContent: "center", display: "flex" }}>
